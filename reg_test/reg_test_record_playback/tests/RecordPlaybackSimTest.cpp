...
TEST_F(RapidSenseTestFixture, RecordPlaybackTest) {
  ...
  // This part of the test doesn't work right now so commenting it out, right
  // now basic recording and playback functionality work.
  ...
  // rtr::JointConfiguration joint_config_1 =
  // rtr::JointConfiguration({0,0,0,0,0,0}); rtr_msgs::TeleportRobot
  // teleport_srv_1; teleport_srv_1.request.joint_config =
  // joint_config_1.GetData(); EXPECT_TRUE(teleport_service.call(teleport_srv_1)
  // && teleport_srv_1.response.is_success);
  ...
  // rtr::JointConfiguration joint_config_2 =
  // rtr::JointConfiguration({Pi,Pi,Pi,Pi,Pi,Pi}); rtr_msgs::TeleportRobot
  // teleport_srv_2; teleport_srv_2.request.joint_config =
  // joint_config_2.GetData(); EXPECT_TRUE(teleport_service.call(teleport_srv_2)
  // && teleport_srv_1.response.is_success);
